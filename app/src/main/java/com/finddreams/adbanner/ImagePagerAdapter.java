...
public class ImagePagerAdapter extends BaseAdapter {
    ...
    public ImagePagerAdapter(Context context, List<String> imageIdList, List<String> urllist, List<String> urlTitlesList) {
    ...
    public View getView(final int position, View view, ViewGroup container) {
        ...
        holder.imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String title = urlTitlesList.get(ImagePagerAdapter.this.getPosition(position));
                /*
                ...
                Toast.makeText(context, "点击了第" + getPosition(position) + "美女", 0).show();
            }
        });
